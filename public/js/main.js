            ...
            self.$wrapper.on( 'click', '.btn-cart', function ( e ) {
                ...
                if (
                    ...
                    Riode.Minipopup.open( {
                        ...
                        actionTemplate: '<div class="action-group d-flex mt-3"><a href="cart.html" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Voir le panier</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">Passer au paiement</a></div>'
                    } );
                }
            } );
        }
